      ...
      <div class="panel-body product-info">
        <div class="row">
          ...
          <div class="col-sm-7">
            ...
            <div class="cart_amount"><label>数量</label><input type="text" class="form-controll input-sm" value="1"><span>件</span><span class="stock"></span></div>
            <div class="buttons">
              @if($favored)
        ...
        <div class="product-detail">
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="product-review-ta">
            </div>
          </div>
        </div>
      </div>
